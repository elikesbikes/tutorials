...
char hostName[MAX_HOST_LEN] = "esp32cam"; // Default Host name
char ST_SSID[MAX_HOST_LEN]  = "E-IoT"; //Default router ssid
char ST_Pass[MAX_PWD_LEN] = "josh6020"; //Default router passd
